...
export default function InboxPage() {
  ...
  // Lazy triage — only triage first 5 visible emails, not all at once
  useEffect(() => {
    const untriaged = emails
      .filter((e) => !e.triageResult && !triaging.has(e.id))
      .slice(0, 5); // only first 5 at a time
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ color: "#7a94b0", fontSize: 13, marginTop: 2 }}>
            {total} emails · {emails.filter(e => e.triageResult).length} triaged by AI
          </p>
        </div>
          ...
          <div style={{ padding: "8px 0" }}>
            {[...Array(8)].map((_, i) => (
              <div key={i} style={{
                ...
                <div style={{ flex: 1 }}>
                  <div style={{
                    height: 12, background: "#EBF2FA",
                    borderRadius: 4, width: "35%", marginBottom: 8,
                    animation: "shimmer 1.5s ease-in-out infinite",
                    animationDelay: `${i * 0.1 + 0.1}s`,
                  }}/>
                  <div style={{
                    height: 12, background: "#EBF2FA",
                    borderRadius: 4, width: "65%", marginBottom: 6,
                    animation: "shimmer 1.5s ease-in-out infinite",
                    animationDelay: `${i * 0.1 + 0.2}s`,
                  }}/>
                  <div style={{
                    height: 10, background: "#EBF2FA",
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{
                      ...
                      <span style={{
                        fontSize: 12, color: "#a8bdd1", flexShrink: 0,
                      }}>
                        {timeAgo(email.date)}
                      </span>
                    </div>
